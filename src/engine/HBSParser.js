                ...
                if ("{" === a)
                    ...
                    f(); a; ) {
                        ...
                        if ('"' === a || "'" === a)
                            ...
                            for (c = a,
                            "_" !== a && "$" !== a && ("a" > a || "z" < a) && ("A" > a || "Z" < a) && d("Bad identifier as unquoted key"); b() && ("_" === a || "$" === a || "a" <= a && "z" >= a || "A" <= a && "Z" >= a || "0" <= a && "9" >= a); )
                                c += a;
                        f();
                        b(":");
                        e[c] = p();
