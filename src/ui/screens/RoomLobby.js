...
export class RoomLobby {
  ...
  _updateOvertimeUI() {
    ...
    const presets = [
      ...
      { name: 'Arsenal', angle: 0, avatarColor: 'FFFFFF', colors: ['FFFFFF','DA291C'], flag: '/assets/uk.png' },
      { name: 'Chelsea', angle: 0, avatarColor: 'eecc1d', colors: ['eecc1d','034694'], flag: '/assets/uk.png' },
