...
export class RoomLobby {
  ...
  _setupJerseySelector() {
    ...
    const presets = [
      ...
      { name: 'Fenerbahçe', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','FFC900','002D72','FFC900'], flag: '/assets/tr.png' },
      { name: 'Beşiktaş', angle: 0, textColor: '111111', colors: ['111111','FFFFFF'], flag: '/assets/tr.png' },
      { name: 'Trabzonspor', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','7A1731','2A9FD6','7A1731'], flag: '/assets/tr.png' },
      { name: 'Rizespor', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','13107A','00945F','13107A'], flag: '/assets/tr.png' },
      { name: 'Manchester United', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','DA291C'], flag: '/assets/uk.png' },
      { name: 'Manchester City', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','6CABDD'], flag: '/assets/uk.png' },
      { name: 'Liverpool', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','DA291C'], flag: '/assets/uk.png' },
      { name: 'Arsenal', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','DA291C'], flag: '/assets/uk.png' },
      { name: 'Chelsea', angle: 0, textColor: 'eecc1d', colors: ['eecc1d','034694'], flag: '/assets/uk.png' },
      { name: 'Aston Villa', angle: 0, textColor: 'bbd2f2', colors: ['bbd2f2','6E303F'], flag: '/assets/uk.png' },
      { name: 'Real Madrid', angle: 0, textColor: '143832', colors: ['143832','FFFFFF'], flag: '/assets/es.png' },
      { name: 'Barcelona', angle: 0, textColor: 'dd9721', colors: ['dd9721','2C3F83','781028'], flag: '/assets/es.png' },
      { name: 'Atlético Madrid', angle: 0, textColor: '0f5ac5', colors: ['0f5ac5','FFFFFF','D40424','FFFFFF'], flag: '/assets/es.png' },
      { name: 'Juventus', angle: 0, textColor: 'd4be88', colors: ['d4be88','000000','FFFFFF','000000'], flag: '/assets/it.png' },
      { name: 'Inter Milan', angle: 0, textColor: 'f0ba56', colors: ['f0ba56','0068A8','000000','0068A8'], flag: '/assets/it.png' },
      { name: 'AC Milan', angle: 0, textColor: 'FFFFFF', colors: ['FFFFFF','000000','AC1F2D','000000'], flag: '/assets/it.png' },
